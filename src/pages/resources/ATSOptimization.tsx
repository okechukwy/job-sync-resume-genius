  ...
  const sections = [
    {
      ...
      content: [
        "ATS (Applicant Tracking System) scans and parses resume content",
        "Systems look for specific keywords and phrases from job descriptions",
        "Formatting and structure affect how well ATS can read your resume",
        "Most large companies use ATS to filter applications before human review"
      ]
    },
    {
      title: "Keyword Optimization Strategies",
      content: [
        "Mirror the language used in job descriptions",
    ...
    },
    {
      ...
      content: [
        ...
        "Save and submit as both PDF and Word formats when possible"
      ]
    },
    {
      title: "Testing Your Resume Through ATS",
      content: [
        "Use free ATS scanning tools to test your resume",
        "Check keyword density and match percentage",
        "Ensure all sections are properly parsed",
        "Make adjustments based on scanning results"
      ]
    },
    {
      title: "Industry-Specific ATS Requirements",
      content: [
        "Tech roles: Include programming languages and technical skills",
        "Healthcare: Emphasize certifications and medical terminology",
        "Finance: Highlight relevant regulations and compliance experience",
        "Marketing: Focus on campaign metrics and digital marketing tools"
      ]
    }
  ];
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">12 min read</div>
              </div>
            </div>
          </div>
        </div>
