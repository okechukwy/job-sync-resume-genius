...
import { Wand2, Download, Copy, RefreshCw, AlertCircle, FileText, File, FileImage, Sparkles, ChevronDown } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-hero">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <Collapsible open={isGuideOpen} onOpenChange={setIsGuideOpen} className="mb-12">
            ...
            <CollapsibleTrigger asChild>
              <CardHeader className="cursor-pointer hover:bg-muted/20 transition-colors">
                <CardTitle className="flex items-center justify-between">
                  ...
                  <ChevronDown className={`h-5 w-5 transition-transform duration-200 ${isGuideOpen ? 'rotate-180' : ''}`} />
                </CardTitle>
              </CardHeader>
            </CollapsibleTrigger>
            <CollapsibleContent>
