...
const BusinessProfessional = () => {
  return (
    <div className="min-h-screen bg-gradient-hero relative overflow-hidden">
      {/* Business Industry Background Pattern */}
      <div className="absolute inset-0 opacity-[0.02]">
        <div className="absolute top-20 left-20 w-32 h-32 border border-primary/20 transform rotate-12">
          <div className="absolute inset-4 border border-primary/15 transform -rotate-6"></div>
        </div>
        <div className="absolute bottom-32 right-24 w-24 h-24 border border-primary/15 rotate-45">
          <div className="absolute inset-3 bg-primary/8"></div>
        </div>
        <div className="absolute top-1/2 left-1/3 w-28 h-28 border border-primary/10 transform -rotate-12"></div>
      </div>
      ...
      <div className="absolute inset-0 opacity-[0.015]">
        ...
        <div className="absolute top-0 right-1/4 w-px h-full bg-gradient-to-b from-transparent via-primary/8 to-transparent"></div>
        <div className="absolute top-1/4 left-0 w-full h-px bg-gradient-to-r from-transparent via-primary/8 to-transparent"></div>
