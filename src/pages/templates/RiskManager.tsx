      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="typography-body max-w-2xl mx-auto animate-fade-in text-contrast-medium">
            Specialized for risk management professionals showcasing strategic thinking and analytical expertise.
          </p>
          
          <div className="flex flex-wrap justify-center gap-2 mt-6 animate-fade-in">
            <Badge variant="outline" className="hover-scale">Risk Assessment</Badge>
        ...
        <TemplateActions templateName="Risk Manager" />
      </div>
    </div>
  );
};
