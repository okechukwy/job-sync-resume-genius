      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Professional blue design for researchers and academic professionals who need to highlight their scholarly achievements.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <Card className="glass-card">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    <span className="text-sm">Publication Emphasis</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
            ...
            <Card className="glass-card">
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {["Research", "Academia", "Education", "Science"].map((industry, index) => (
