      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="typography-body max-w-2xl mx-auto animate-fade-in text-contrast-medium">
            Investment and portfolio management specialists showcasing performance-driven results.
          </p>
          
          <div className="flex flex-wrap justify-center gap-2 mt-6 animate-fade-in">
            <Badge variant="outline" className="hover-scale">Investment</Badge>
            <Badge variant="outline" className="hover-scale">Strategic</Badge>
            <Badge variant="outline" className="hover-scale">Performance-Driven</Badge>
          </div>
        </div>
        ...
        <TemplateActions templateName="Portfolio Manager" />
      </div>
    </div>
  );
};
