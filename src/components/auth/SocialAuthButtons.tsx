    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-3 gap-2">
        <Button
          ...
          className="h-10 bg-card/50 hover:bg-card border-border/50 hover:border-border transition-all duration-200"
        >
        ...
        >
          {loadingProvider === 'google' ? (
            ...
            <div className="mr-2 h-4 w-4 bg-gradient-to-r from-blue-500 via-red-500 to-yellow-500 rounded-sm flex items-center justify-center">
