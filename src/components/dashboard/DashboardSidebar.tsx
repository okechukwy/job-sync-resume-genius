import { FileText, Search, Users, TrendingUp, MessageSquare, Linkedin, Award, Briefcase, BookOpen, HelpCircle, Download, Home, GitBranch, Target, UserCheck, HeartHandshake, Sparkles } from "lucide-react";
...
const getNavigationItems = () => {
  const baseItems = [{
    ...
    items: [{
      ...
      title: "ATS Analysis",
      url: "/dashboard/resume/ats-analysis",
      icon: Search
    }, {
    ...
    items: [{
      title: "Job Matching",
      url: "/dashboard/job-search/matching",
      icon: Target
    }, {
      title: "Performance Tracking",
      url: "/dashboard/job-search/performance",
      icon: TrendingUp
    }, {
      title: "Cover Letter Generator",
      url: "/dashboard/job-search/cover-letter",
      icon: MessageSquare
    }]
  }, {
    ...
    items: [{
      ...
      url: "/dashboard/career/interview-prep",
      icon: Users
    }, {
      title: "LinkedIn Optimization",
      url: "/dashboard/career/linkedin",
      icon: Linkedin
    }, {
      title: "Personal Branding",
      url: "/dashboard/career/branding",
      icon: Award
    }, {
      title: "Career Coaching",
      url: "/dashboard/career/coaching",
      icon: HeartHandshake
    }]
  }, {
...
export const DashboardSidebar = () => {
  ...
  return <Sidebar className="sidebar-glass">
      <SidebarHeader className="sidebar-header-glass p-4">
        <div className="flex items-center gap-2">
          ...
          {state === "expanded" && <div>
              <h2 className="text-lg font-bold gradient-text">Jobzuma</h2>
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton asChild isActive={isActive("/dashboard")} className={`
                  smooth-transition
        ...
        {/* Navigation Groups */}
        {navigationItems.slice(1).map((group, index) => <SidebarGroup key={index}>
